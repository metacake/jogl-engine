...
class SetupVBO extends JOGLInstruction<GL3bc> {
    ...
    public void render(GL3bc gl) {
        ...
        gl.glBindBuffer(GL3bc.GL_ARRAY_BUFFER, vbo);
        gl.glBufferData(GL3bc.GL_ARRAY_BUFFER, buffer.capacity() * Buffers.SIZEOF_FLOAT, buffer, GL3bc.GL_STATIC_DRAW);
        gl.glBindBuffer(GL3bc.GL_ARRAY_BUFFER, vbo);
